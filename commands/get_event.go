...
func (c *GetEvent) Help() {
	fmt.Println("Usage: uhppoted-cli [options] get-events <serial number> [index]")
	fmt.Println()
	...
	fmt.Println()
	fmt.Println("    uhppoted-cli get-event 12345678 17")
	fmt.Println()
	...
	fmt.Println()
	fmt.Println("    uhppoted-cli get-event 12345678")
	fmt.Println()
	fmt.Println("    > 405419896  23   2019-07-24 20:31:18 3922570474   1 true  0")
	fmt.Println()
	fmt.Println("    uhppoted-cli get-event 12345678 first")
	fmt.Println()
	fmt.Println("    > 405419896  1    2019-07-09 21:00:55 3922570474   1 true  0")
	fmt.Println()
	fmt.Println("    uhppoted-cli get-event 12345678 last")
	fmt.Println()
